  ...
  begin
    ...
    begin
      ...
      try
        ...
        begin
          Result := '000000';
          raise Exception.Create('No momento não foi possível incluir no registro geral de códigos. Tente mais tarde !' + #13 + 'Erro: ' + E.Message);
        end;
      end;
      result := Self.zerarcodigo(inttostr(Xcod), 6);
    end
    else
      raise Exception.Create('Não foi possível concluir com a operação !' + #13 + 'Erro: Código de sequência não encontrado na tabela de códigos.');
  end;
