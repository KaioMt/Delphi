...
//  end;
  ...
  begin
    ...
    sql.Add('and o.conclusao_data between :di and :df');

    ParamByName('di').AsString := FormatDateTime('yyyy-mm-dd' ,dtEdInicio.DateTime);
    ParamByName('df').AsString := FormatDateTime('yyyy-mm-dd', dtEdFim.DateTime);
    open;
  end;
